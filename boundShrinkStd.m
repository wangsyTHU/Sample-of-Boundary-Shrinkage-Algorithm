function [paramb, status, outDistVec, parambVec] = boundShrinkStd(matE, matf, matC, matd, paramA)
% using the given template to implement the bound shrinkage of a polytope
% so that the resulting polytope is inner-approximated in the real polytope (standard version)
% 
